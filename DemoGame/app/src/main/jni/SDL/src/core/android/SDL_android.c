...
#define SDL_JAVA_PREFIX                                 koisignal_hexahop_per
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved)
{
    ...
    register_methods(env, "koisignal/hexahop/per/SDLActivity", SDLActivity_tab, SDL_arraysize(SDLActivity_tab));
    register_methods(env, "koisignal/hexahop/per/SDLInputConnection", SDLInputConnection_tab, SDL_arraysize(SDLInputConnection_tab));
    register_methods(env, "koisignal/hexahop/per/SDLAudioManager", SDLAudioManager_tab, SDL_arraysize(SDLAudioManager_tab));
    register_methods(env, "koisignal/hexahop/per/SDLControllerManager", SDLControllerManager_tab, SDL_arraysize(SDLControllerManager_tab));
